    ...
    return (
        ...
        <Layout>
            <div className={styles.contentWrapper}>
                ...
                <p>
                Our mission is to help as many people as possible to have great careers in health technology. We believe that by developing and nurturing talent in the industry, healthcare can be greatly improved. In addition to our jobs board, we are building a community of people who would like to develop their careers in health tech and life sciences.
                </p>
                </div>
            </div>
        </Layout>
